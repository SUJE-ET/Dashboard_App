...
def index():
    ...
    earning_this_month =monthly_earnings[-1][2]
    monthly_goal_percentage = (earning_this_month/total_goal)*100
    ...
    for product in revenue_per_product:
        ...
        product_label.append(product[0])
    ...
    context = {
        ...
        "monthly_earnings":earning_this_month,
